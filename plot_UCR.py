...
#una opcion de warp en inlineskate
plt.figure()
plt.plot(train_x.values[ind_class[4][3], :][0].values)
plt.plot(train_x.values[ind_class[6][3], :][0].values)
# dkjh
...
plt.figure()
plt.plot(train_x.values[ind_class[1][0], :][0].values)
plt.plot(train_x.values[ind_class[2][0], :][0].values)

plt.figure()
plt.plot(train_x.values[ind_class[1][1], :][0].values)
plt.plot(train_x.values[ind_class[2][1], :][0].values)



plt.figure()
plt.plot(train_x.values[ind_class[0][2], :][0].values)
plt.plot(train_x.values[ind_class[1][13], :][0].values)




plt.figure()
plt.plot(train_x.values[ind_class[3][3], :][0].values)
plt.plot(train_x.values[ind_class[7][0], :][0].values)
...
k = train_x.values[ind_class[1][1], :][0].values
plt.plot(k)
...
which_class = 2
dis = np.zeros((len(ind_class[which_class])))
for t in range(len(ind_class[which_class])):
    dis[i] = dtw_distance(train_x.values[ind_class[which_class][t],:][0].values, k)
