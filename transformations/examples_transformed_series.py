...
plt.figure(figsize=(7,5))
plt.plot(ref,linewidth=3, label="Reference TS")
#plt.plot(scale(ref,100,150,0.8),linewidth=3, label="Scaled TS")
...
plt.figure(figsize=(7,5))
plt.plot(ref,linewidth=3, label="Reference TS")
#plt.plot(scale(ref,30,80,0.7),linewidth=3, label="Scaled TS")
...
plt.figure(figsize=(7,5))
plt.plot(ref,linewidth=3, label="Reference TS")
plt.plot(shift(ref,20,230),linewidth=3, label="Shifted TS")
plt.xlabel("t", size=20)
plt.xticks(size=20)
plt.yticks(size=20)
plt.ylim(-2,2)
...
plt.figure(figsize=(7,5))
plt.plot(warp(ref,40,100,0.7),linewidth=3, label="Neighbour",color="C1")
plt.xlabel("t", size=25)
plt.xticks(size=25)
plt.yticks(size=25)
plt.xlim(-10,260)
...
plt.figure(figsize=(7,5))
#plt.plot(ref,linewidth=3, label="Reference TS")
plt.plot(warp(ref,120,250,0.7),linewidth=3, label="Neighbour",color="C1")
plt.xlabel("t", size=25)
plt.xticks(size=25)
plt.yticks(size=25)
plt.xlim(-10,260)
...
plt.figure(figsize=(7,5))
# plt.plot(ref,linewidth=3, label="Reference TS")
plt.plot(warp(ref,1,100,0.7),linewidth=3, label="Neighbour",color="C1")
plt.xlabel("t", size=25)
plt.xticks(size=25)
plt.yticks(size=25)
plt.xlim(-10,260)
